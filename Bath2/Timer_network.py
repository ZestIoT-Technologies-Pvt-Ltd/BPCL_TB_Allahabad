...
config1="/home/zestiot/BPCL_1/BPCL_final/UI_parameters.json"
...
vid_path="/home/zestioit/"
video_flag =0
temp_file="/home/zestiot/"
...
def start_video(event):
	...
	vid_name="DESKTOP_ALH_BPCL_NX1_"+description+"_"+event+"_"+(datetime.now()).strftime("%Y-%m-%dT%H-%M-%S")+".avi"
	if event == "EVENT21_ON":
		Ppath = loc+vid_name
...
def event_call(event,temp,path):
	...
	try:
		sc=ClientSocket(device_id=str('BPCL_ALH_NX_0002'))
